...
Semantic Role Labeling (SRL) bezeichnet die [TODO: automatisierte?] Erkennung und
...
Für die englische Sprache existieren bereits vielversprechende SRL-Systeme, wie \cite{das_semafor_2010, johansson_lth_2007, gildea}, und mit \cite{erk2006shalmaneser} auch für das Deutsche. Allerdings ist den Autoren diese Arbeit kein System bekannt, das mit nicht-verbalen Prädikaten umgehen kann.
