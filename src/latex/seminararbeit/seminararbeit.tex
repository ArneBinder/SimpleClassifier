...
%TODO Bild
Der implementierte SRL-Klassifikator wurde im Hinblick auf drei Kenngrößen evaluiert.
%TODO
...
\subsection{Einordnung der Ergebnisse}
	...
	\begin{table}
		...
		\caption{Ergebniss der CoNLL-2009 Shared Task, SRL-only Task, Semantic Labeled F1 \citep{hajivc2009conll}}
	\end{table}
